...
import { X, UserCircle, Camera, Mail, ShieldCheck, LogOut, Loader2 } from "lucide-react";
        ...
        <div className="flex-1 overflow-y-auto px-8 py-10 space-y-10">
          ...
          <div className="flex flex-col items-center">
            <div className="relative group">
              <div className={`h-28 w-28 rounded-3xl bg-slate-100 flex items-center justify-center overflow-hidden border-4 border-white shadow-xl transition-all ${isUploading ? 'opacity-50' : 'group-hover:ring-4 group-hover:ring-blue-50'}`}>
                {avatarUrl ? (
          ...
          <div className="grid gap-6">
            <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-50 pb-2">Information</h4>
            <div className="space-y-5">
               ...
               <div className="flex items-center gap-4">
                  <div className="p-2.5 bg-emerald-50 rounded-xl"><ShieldCheck className="w-4 h-4 text-emerald-600" /></div>
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase">Access Role</p>
                    <Badge className="bg-emerald-100 text-emerald-700 border-none px-2 py-0 text-[10px] uppercase font-black">
                      {user?.role}
                    </Badge>
                  </div>
               </div>
