    ...
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className="relative w-full max-w-[450px] bg-white h-full shadow-2xl flex flex-col">
        <Card className="h-full rounded-none border-none flex flex-col shadow-none overflow-hidden">
          ...
          <CardContent className="flex-1 px-10 py-10 overflow-y-auto">
            {loading ? (
              ...
              <div className="relative">
                ...
                <div className="space-y-12">
                  {events.map((event) => {
                    ...
                    return (
                      <div key={event._id} className="relative pl-14 group">
                        <div
                          className={`absolute left-0 top-0 w-10 h-10 rounded-2xl flex items-center justify-center border-4 border-white shadow-sm ${config.bg} ${config.border}`}
                        >
